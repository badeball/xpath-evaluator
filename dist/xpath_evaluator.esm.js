...
import { RELATIVE_LOCATION_PATH, EQUALITY, INEQUALITY, ABSOLUTE_LOCATION_PATH, ADDITIVE, AND, DIVISIONAL, FILTER, FUNCTION_CALL, GREATER_THAN, GREATER_THAN_OR_EQUAL, LESS_THAN, LESS_THAN_OR_EQUAL, LITERAL, MODULUS, MULTIPLICATIVE, NEGATION, NUMBER, OR, PATH, SUBTRACTIVE, UNION } from 'xpath-analyzer/lib/expr_type';
import { ANCESTOR_OR_SELF, FOLLOWING_SIBLING, DESCENDANT_OR_SELF, PRECEDING_SIBLING, ANCESTOR, ATTRIBUTE, CHILD, DESCENDANT, FOLLOWING, NAMESPACE, PARENT, PRECEDING, SELF } from 'xpath-analyzer/lib/axis_specifier';
import { NODE, COMMENT, PROCESSING_INSTRUCTION, TEXT } from 'xpath-analyzer/lib/node_type';
