import XPathAnalyzer, { RELATIVE_LOCATION_PATH, ANCESTOR_OR_SELF, NODE_TYPE_TEST, NODE, FOLLOWING_SIBLING, DESCENDANT_OR_SELF, PRECEDING_SIBLING, NODE_NAME_TEST, PROCESSING_INSTRUCTION_TEST, COMMENT, PROCESSING_INSTRUCTION, TEXT, ANCESTOR, PRECEDING, ATTRIBUTE, CHILD, DESCENDANT, FOLLOWING, NAMESPACE, PARENT, SELF, EQUALITY, INEQUALITY, BOOLEAN, CEILING, CONCAT, CONTAINS, COUNT, FALSE, FLOOR, ID, LAST, LOCAL_NAME, NAME, NORMALIZE_SPACE, NOT, NUMBER, POSITION, ROUND, STARTS_WITH, STRING_LENGTH, STRING, SUBSTRING_AFTER, SUBSTRING_BEFORE, SUBSTRING, SUM, TRANSLATE, TRUE, ABSOLUTE_LOCATION_PATH, ADDITIVE, AND, DIVISIONAL, FILTER, FUNCTION_CALL, GREATER_THAN, GREATER_THAN_OR_EQUAL, LESS_THAN, LESS_THAN_OR_EQUAL, LITERAL, MODULUS, MULTIPLICATIVE, NEGATION, OR, PATH, SUBTRACTIVE, UNION } from 'xpath-analyzer';
...
export { XPathResult, ELEMENT_NODE, ATTRIBUTE_NODE, TEXT_NODE, CDATA_SECTION_NODE, ENTITY_REFERENCE_NODE, ENTITY_NODE, PROCESSING_INSTRUCTION_NODE, COMMENT_NODE, DOCUMENT_NODE, DOCUMENT_TYPE_NODE, DOCUMENT_FRAGMENT_NODE, NOTATION_NODE };
